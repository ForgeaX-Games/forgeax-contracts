# ForgeaX Studio — forgeax-contracts

[English](./README.md) · [简体中文](./README.zh-CN.md) · [↑ studio](https://github.com/ForgeaX-Games/forgeax-studio)

Shared contracts — @forgeax/types + @forgeax/agent-runtime: the type definitions and agent-runtime base the server, cli and core build on.
